  ...
  return (
    ...
    >
      ...
      {open && (
        <div
          id="mobile-nav"
          className="fixed inset-0 top-16 z-40 flex flex-col bg-ink lg:hidden"
          role="dialog"
          aria-modal="true"
          ...
          <nav aria-label="Mobile" className="container-site flex flex-1 flex-col gap-1 overflow-y-auto py-8">
            {NAV_LINKS.map((link) => (
              <a
                ...
                className="flex items-center justify-between border-b border-white/[0.06] py-5 text-2xl font-medium text-white/85 transition-all duration-300 hover:text-white"
              >
                {link.label}
