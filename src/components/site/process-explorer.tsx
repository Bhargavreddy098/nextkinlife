          ...
          return (
            <li key={s.step} className="relative shrink-0 lg:shrink">
              <button
                ...
                className={cn(
                  "relative group flex w-full items-center gap-4 rounded-xl px-4 py-3.5 text-left transition-all lg:rounded-none lg:px-2 lg:py-5",
              ...
              >
                ...
                {selected && (
                  <motion.div
                    ...
                    className="absolute inset-0 rounded-xl bg-card border border-line lg:hidden"
                    aria-hidden="true"
                  />
                )}
                ...
                <span
                  aria-hidden="true"
                  className={cn(
                    "relative z-10 ml-auto hidden h-px flex-1 transition-all lg:block lg:mx-5",
                ...
                <ArrowRight
                  className={cn(
                    "relative z-10 hidden h-4 w-4 shrink-0 transition-all lg:block",
